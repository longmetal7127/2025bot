...
public class Elevator extends SubsystemBase {
  ...
  private final MechanismLigament2d m_armMech2d = m_elevatorCarriageMech2d.append(
      new MechanismLigament2d(
          "Arm",
          SimulationRobotConstants.kArmLength.in(Meters) * SimulationRobotConstants.kPixelsPerMeter,
  ...
  public void periodic() {
    ...
    m_elevatorCarriageMech2d
        .setLength(SimulationRobotConstants.kPixelsPerMeter * SimulationRobotConstants.kMinElevatorCarriageHeightMeters
            + carriageHeight);
    m_elevatorStage1Mech2d
        .setLength(SimulationRobotConstants.kPixelsPerMeter * SimulationRobotConstants.kMinElevatorStage1HeightMeters
            + stage1Height);
