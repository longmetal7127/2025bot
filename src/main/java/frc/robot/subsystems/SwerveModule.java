...
public class SwerveModule {
        ...
        private final DCMotorSim driveMotorSim = new DCMotorSim(
                        LinearSystemId.createDCMotorSystem(DCMotor.getNeoVortex(1),
                                        Units.lbsToKilograms(115)
                                                        * Math.pow(ModuleConstants.kWheelDiameterMeters / 2, 2) / 4,
        ...
        public void incrementSim(double dt) {
                ...
                m_turningEncoderSim.iterate(
                                turnMotorSim.getAngularVelocityRadPerSec() / ModuleConstants.kTurningMotorReduction,
                                dt);
